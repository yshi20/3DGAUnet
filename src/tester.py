...
def tester(args):
    ...
    # image_saved_path = paramt.images_dir
    image_saved_path = paramt.output_dir + '/' + args.model_name + '/' + args.logs + '/test_outputs'
    ...
    for i in range(N):
        ...
        namefile1 = 'test_fake_gen_'+ str(i)+'.mat'
        namefile2 = '../outputs/test_gen_'+ str(i)+'.mat'
        #io.savemat(namefile1, fake)
        io.savemat(namefile2, {"instance":samples[0,:,:,:]})
        # visualization
